...
<script src="${pageContext.request.contextPath}/resource/js/member/login.js"></script>
<div class="login-form-box con">
	<form action="doLogin" method="POST" class="login-form" onsubmit="submitJoinForm(this); return false;">
		<div class="form-row">
